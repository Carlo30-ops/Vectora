...
"""
from PySide6.QtWidgets import QDialog, QLabel, QVBoxLayout, QGraphicsOpacityEffect
...
class NotificationManager:
    ...
    def show_notification(
        ...
        label.setStyleSheet(NotificationManager.STYLES.get(notification_type, NotificationManager.STYLES[NotificationManager.INFO]))
    ...
    def show_success(parent, message: str, duration: int = 3000):
        ...
        NotificationManager.show_notification(parent, f"✓ {message}", NotificationManager.SUCCESS, duration)
    
    @staticmethod
    def show_error(parent, message: str, duration: int = 4000):
        """Muestra notificación de error"""
        NotificationManager.show_notification(parent, f"✗ {message}", NotificationManager.ERROR, duration)
    
    @staticmethod
    def show_warning(parent, message: str, duration: int = 3500):
        """Muestra notificación de advertencia"""
        NotificationManager.show_notification(parent, f"⚠ {message}", NotificationManager.WARNING, duration)
    
    @staticmethod
    def show_info(parent, message: str, duration: int = 3000):
        """Muestra notificación informativa"""
        NotificationManager.show_notification(parent, f"ℹ {message}", NotificationManager.INFO, duration)
