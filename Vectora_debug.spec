...
# Vectora v5.0.0 - PyInstaller Spec File (DEBUG VERSION)
# Versión con console=True para ver errores durante desarrollo
...
exe = EXE(
    ...
    name='Vectora_debug',  # Nombre diferente para no sobrescribir la versión release
    debug=True,  # Habilitar información de depuración
    bootloader_ignore_signals=False,
    strip=False,
    upx=True,
    console=True,  # CONSOLA HABILITADA PARA VER ERRORES
