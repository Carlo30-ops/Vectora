...
class CompressWidget(BaseOperationWidget):
    ...
    def start_processing(self):
        ...
        output_file = str(settings.OUTPUT_DIR / f"compressed_{FileHandler.get_filename(self.input_file)}")
    ...
    def on_success(self, result):
        ...
        msg = (f"¡Compresión exitosa!\n"
               f"Ahorro: {result['savings_percent']}%\n"
               f"Tamaño final: {result['compressed_size_mb']} MB")
