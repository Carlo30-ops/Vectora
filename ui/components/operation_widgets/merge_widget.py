...
class MergeWidget(BaseOperationWidget):
    ...
    def __init__(self):
        super().__init__("📑 Combinar PDFs", "Une múltiples archivos PDF en un solo documento")
        self.files = []
    ...
    def add_files(self):
        ...
        files, _ = QFileDialog.getOpenFileNames(
            self, "Seleccionar PDFs", str(Path.home()), "Archivos PDF (*.pdf)"
        )
    ...
    def start_processing(self):
        ...
        output_file, _ = QFileDialog.getSaveFileName(
            self, "Guardar PDF Combinado", str(default_name), "Archivos PDF (*.pdf)"
        )
