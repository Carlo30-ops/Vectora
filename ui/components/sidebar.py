...
from .ui_helpers import AnimatedButton, IconHelper
...
class Sidebar(QWidget):
    ...
    def init_ui(self):
        ...
        sep.setStyleSheet(
            "background-color: transparent; max-height: 10px;"
        )  # Managed by QSS mostly
    ...
    def update_icons(self):
        ...
        if hasattr(self, "title_label"):
            self.title_label.setStyleSheet(
                f"color: {text_primary}; font-weight: 800; border: none;"
            )
    ...
    def create_nav_button(
        self, view_id: str, label: str, icon_name: str, has_badge: bool = False
    ) -> QPushButton:
