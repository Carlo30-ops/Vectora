...
class PDFSecurity:
        ...
        try:
            with pikepdf.open(input_path) as pdf:
                ...
                if permissions:
                    ...
                    encryption_dict = pikepdf.Encryption(owner=password, user=password, R=6)
    ...
    def decrypt_pdf(self, input_path: str, output_path: str, password: str) -> OperationResult:
    ...
    def validate_password_strength(self, password: str) -> Dict[str, Any]:
        ...
        is_strong = length >= 8 and has_upper and has_lower and has_digit
